...
const (
	ProjectService_ListProjects_FullMethodName      = "/arp.v1.ProjectService/ListProjects"
	ProjectService_RegisterProject_FullMethodName   = "/arp.v1.ProjectService/RegisterProject"
	ProjectService_UnregisterProject_FullMethodName = "/arp.v1.ProjectService/UnregisterProject"
)
...
//
// ProjectService manages project configurations.
// A project defines a repository, branch, and agent templates.
// Workspaces are created from projects.
type ProjectServiceClient interface {
	// Lists all registered projects.
	ListProjects(ctx context.Context, in *ListProjectsRequest, opts ...grpc.CallOption) (*ListProjectsResponse, error)
	// Registers a new project configuration.
	RegisterProject(ctx context.Context, in *RegisterProjectRequest, opts ...grpc.CallOption) (*Project, error)
	// Unregisters a project. Fails if active workspaces reference it.
	UnregisterProject(ctx context.Context, in *UnregisterProjectRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *projectServiceClient) RegisterProject(ctx context.Context, in *RegisterProjectRequest, opts ...grpc.CallOption) (*Project, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Project)
...
func (c *projectServiceClient) UnregisterProject(ctx context.Context, in *UnregisterProjectRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProjectServiceServer interface {
	...
	// Unregisters a project. Fails if active workspaces reference it.
	UnregisterProject(context.Context, *UnregisterProjectRequest) (*emptypb.Empty, error)
...
func (UnimplementedProjectServiceServer) RegisterProject(context.Context, *RegisterProjectRequest) (*Project, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterProject not implemented")
}
func (UnimplementedProjectServiceServer) UnregisterProject(context.Context, *UnregisterProjectRequest) (*emptypb.Empty, error) {
...
func _ProjectService_UnregisterProject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnregisterProjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectServiceServer).UnregisterProject(ctx, req.(*UnregisterProjectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProjectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "arp.v1.ProjectService",
